    ...
    <div className="min-h-screen bg-[#F5F5F0] flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-[32px] p-8 shadow-xl shadow-black/5">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-3xl font-serif font-bold text-[#1A1A1A]">Create Account</h1>
          <p className="text-[#1A1A1A]/60 mt-2">Start your journey to success</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-2">
            <label className="text-sm font-medium text-[#1A1A1A]/60 ml-1">Full Name</label>
            <div className="relative">
              <User className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-[#1A1A1A]/20" />
              <input
                type="text"
                required
                value={name}
        ...
        <p className="text-center mt-8 text-[#1A1A1A]/60">
          ...
          <Link to="/login" className="text-[#5A5A40] font-bold hover:underline">
            Sign In
          </Link>
        </p>
      </div>
