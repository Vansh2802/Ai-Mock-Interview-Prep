      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white dark:bg-[#141414] rounded-[32px] p-8 shadow-xl shadow-black/5 dark:shadow-white/5 border border-black/5 dark:border-white/5 transition-colors duration-300">
          <div className="flex flex-col items-center mb-8">
            ...
            <h1 className="text-3xl font-serif font-bold text-[#1A1A1A] dark:text-[#F5F5F0]">Welcome Back</h1>
            <p className="text-[#1A1A1A]/60 dark:text-[#F5F5F0]/60 mt-2">Sign in to continue your practice</p>
          </div>
          ...
          <p className="text-center mt-8 text-[#1A1A1A]/60 dark:text-[#F5F5F0]/60">
            ...
            <Link to="/register" className="text-[#5A5A40] dark:text-[#A8A880] font-bold hover:underline">
              Sign Up
            </Link>
          </p>
        </div>
